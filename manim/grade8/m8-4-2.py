...
class Math42Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Време!",
            font="Noto Sans",
            font_size=36,
...
class Math42Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-4-2")
    print(f"To render: manim -ql m8-4-2.py Math42Scene")
    print(f"For 3D: manim -ql m8-4-2.py Math42Scene3D")
