...
Lesson: geo8-7-1 — Русија — најголема земја во светот
...
class Geo71Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Русија — најголема земја во светот",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Русија — најголема земја во светот!",
            font="Noto Sans",
            font_size=36,
...
class Geo71Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Русија — најголема земја во светот (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-7-1")
    print(f"To render: manim -ql geo8-7-1.py Geo71Scene")
    print(f"For 3D: manim -ql geo8-7-1.py Geo71Scene3D")
