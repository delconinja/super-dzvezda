...
Lesson: geo8-1-2 — Релјеф на Европа
...
class Geo12Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Релјеф на Европа!",
            font="Noto Sans",
            font_size=36,
...
class Geo12Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-1-2")
    print(f"To render: manim -ql geo8-1-2.py Geo12Scene")
    print(f"For 3D: manim -ql geo8-1-2.py Geo12Scene3D")
