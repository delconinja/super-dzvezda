...
Lesson: bio8-4-6 — Вилијам Харви и откривање на циркулација
...
class Bio46Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Вилијам Харви и откривање на циркулација",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Вилијам Харви и откривање на циркулација!",
            font="Noto Sans",
            font_size=36,
...
class Bio46Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Вилијам Харви и откривање на циркулација (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-4-6")
    print(f"To render: manim -ql bio8-4-6.py Bio46Scene")
    print(f"For 3D: manim -ql bio8-4-6.py Bio46Scene3D")
