...
Lesson: chem8-3-2 — Хемиски симболи
...
class Chem32Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Хемиски симболи!",
            font="Noto Sans",
            font_size=36,
...
class Chem32Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-3-2")
    print(f"To render: manim -ql chem8-3-2.py Chem32Scene")
    print(f"For 3D: manim -ql chem8-3-2.py Chem32Scene3D")
