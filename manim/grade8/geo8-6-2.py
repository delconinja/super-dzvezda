...
Lesson: geo8-6-2 — Алписки земји: Австрија и Швајцарија
...
class Geo62Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Алписки земји: Австрија и Швајцарија",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Алписки земји: Австрија и Швајцарија!",
            font="Noto Sans",
            font_size=36,
...
class Geo62Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Алписки земји: Австрија и Швајцарија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-6-2")
    print(f"To render: manim -ql geo8-6-2.py Geo62Scene")
    print(f"For 3D: manim -ql geo8-6-2.py Geo62Scene3D")
