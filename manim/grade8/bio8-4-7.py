...
Lesson: bio8-4-7 — Крвни групи и трансфузија
...
class Bio47Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Крвни групи и трансфузија!",
            font="Noto Sans",
            font_size=36,
...
class Bio47Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-4-7")
    print(f"To render: manim -ql bio8-4-7.py Bio47Scene")
    print(f"For 3D: manim -ql bio8-4-7.py Bio47Scene3D")
