...
Lesson: m8-4-1 — Должина, маса и зафатнина
...
class Math41Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Должина, маса и зафатнина!",
            font="Noto Sans",
            font_size=36,
...
class Math41Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-4-1")
    print(f"To render: manim -ql m8-4-1.py Math41Scene")
    print(f"For 3D: manim -ql m8-4-1.py Math41Scene3D")
