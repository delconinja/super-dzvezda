...
Lesson: bio8-6-1 — Зошто класифицираме?
...
class Bio61Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Зошто класифицираме?!",
            font="Noto Sans",
            font_size=36,
...
class Bio61Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-6-1")
    print(f"To render: manim -ql bio8-6-1.py Bio61Scene")
    print(f"For 3D: manim -ql bio8-6-1.py Bio61Scene3D")
