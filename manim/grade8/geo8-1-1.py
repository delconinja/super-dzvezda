...
Lesson: geo8-1-1 — Географска положба и брегова разгранетост
...
class Geo11Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Географска положба и брегова разгранетост",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Географска положба и брегова разгранетост!",
            font="Noto Sans",
            font_size=36,
...
class Geo11Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Географска положба и брегова разгранетост (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-1-1")
    print(f"To render: manim -ql geo8-1-1.py Geo11Scene")
    print(f"For 3D: manim -ql geo8-1-1.py Geo11Scene3D")
