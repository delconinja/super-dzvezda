...
Lesson: bio8-5-4 — Истражување на варијација кај растенија
...
class Bio54Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Истражување на варијација кај растенија",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Истражување на варијација кај растенија!",
            font="Noto Sans",
            font_size=36,
...
class Bio54Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Истражување на варијација кај растенија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-5-4")
    print(f"To render: manim -ql bio8-5-4.py Bio54Scene")
    print(f"For 3D: manim -ql bio8-5-4.py Bio54Scene3D")
