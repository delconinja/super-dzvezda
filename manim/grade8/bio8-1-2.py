...
Lesson: bio8-1-2 — Нервен систем — вовед
...
class Bio12Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Нервен систем — вовед!",
            font="Noto Sans",
            font_size=36,
...
class Bio12Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-1-2")
    print(f"To render: manim -ql bio8-1-2.py Bio12Scene")
    print(f"For 3D: manim -ql bio8-1-2.py Bio12Scene3D")
