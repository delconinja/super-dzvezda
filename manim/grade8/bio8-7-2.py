...
Lesson: bio8-7-2 — Изработка на модел на фосил
...
class Bio72Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Изработка на модел на фосил!",
            font="Noto Sans",
            font_size=36,
...
class Bio72Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Изработка на модел на фосил (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-7-2")
    print(f"To render: manim -ql bio8-7-2.py Bio72Scene")
    print(f"For 3D: manim -ql bio8-7-2.py Bio72Scene3D")
