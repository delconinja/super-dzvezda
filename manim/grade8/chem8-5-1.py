...
Lesson: chem8-5-1 — Вовед во хемијата на јаглеродни соединенија
...
class Chem51Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Вовед во хемијата на јаглеродни соединенија",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Вовед во хемијата на јаглеродни соединенија!",
            font="Noto Sans",
            font_size=36,
...
class Chem51Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Вовед во хемијата на јаглеродни соединенија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-5-1")
    print(f"To render: manim -ql chem8-5-1.py Chem51Scene")
    print(f"For 3D: manim -ql chem8-5-1.py Chem51Scene3D")
