...
Lesson: bio8-1-4 — Рецептори за светлина — окото
...
class Bio14Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Рецептори за светлина — окото!",
            font="Noto Sans",
            font_size=36,
...
class Bio14Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Рецептори за светлина — окото (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-1-4")
    print(f"To render: manim -ql bio8-1-4.py Bio14Scene")
    print(f"For 3D: manim -ql bio8-1-4.py Bio14Scene3D")
