...
LESSONS = {
    ...
    "geography": {
        1: {
            1: ("geo8-1-1.py", "Geo811Scene", "Географска положба и брегова разгранетост"),
            2: ("geo8-1-2.py", "Geo812Scene", "Релјеф на Европа"),
            3: ("geo8-1-3.py", "Geo813Scene", "Клима на Европа"),
            4: ("geo8-1-4.py", "Geo814Scene", "Хидрографија и природни ресурси"),
        },
        2: {
            1: ("geo8-2-1.py", "Geo821Scene", "Население на Европа"),
            2: ("geo8-2-2.py", "Geo822Scene", "Економија на Европа"),
            3: ("geo8-2-3.py", "Geo823Scene", "Македонија во европските интеграции"),
        },
        3: {
            1: ("geo8-3-1.py", "Geo831Scene", "Балкански Полуостров"),
            2: ("geo8-3-2.py", "Geo832Scene", "Италија и Апенински Полуостров"),
            3: ("geo8-3-3.py", "Geo833Scene", "Пиринејски Полуостров (Шпанија и Португалија)"),
            4: ("geo8-3-4.py", "Geo834Scene", "Западен Балкан: Хрватска, Словенија, БиХ, Црна Гора"),
        },
        4: {
            1: ("geo8-4-1.py", "Geo841Scene", "Велика Британија и Ирска"),
            2: ("geo8-4-2.py", "Geo842Scene", "Франција и Бенелукс"),
        },
        5: {
            1: ("geo8-5-1.py", "Geo851Scene", "Скандинавски земји"),
            2: ("geo8-5-2.py", "Geo852Scene", "Балтички држави: Естонија, Латвија, Литванија"),
        },
        6: {
            1: ("geo8-6-1.py", "Geo861Scene", "Германија — водечка држава на Европа"),
            2: ("geo8-6-2.py", "Geo862Scene", "Алписки земји: Австрија и Швајцарија"),
        },
        7: {
            1: ("geo8-7-1.py", "Geo871Scene", "Русија — најголема земја во светот"),
            2: ("geo8-7-2.py", "Geo872Scene", "Украина, Белорусија и Молдавија"),
        },
    },
    "biology": {
        1: {
            1: ("bio8-1-1.py", "Bio811Scene", "Повторување за органски системи"),
            2: ("bio8-1-2.py", "Bio812Scene", "Нервен систем — вовед"),
            3: ("bio8-1-3.py", "Bio813Scene", "Хемиски рецептори — вкус и мирис"),
            4: ("bio8-1-4.py", "Bio814Scene", "Рецептори за светлина — окото"),
            5: ("bio8-1-5.py", "Bio815Scene", "Рецептори за звук — увото"),
            6: ("bio8-1-6.py", "Bio816Scene", "Рецептори во кожата"),
            7: ("bio8-1-7.py", "Bio817Scene", "Ендокрин систем и хормонална регулација"),
            8: ("bio8-1-8.py", "Bio818Scene", "Систем за излачување"),
            9: ("bio8-1-9.py", "Bio819Scene", "Рефлексен лак — брзи автоматски реакции"),
        },
        2: {
            1: ("bio8-2-1.py", "Bio821Scene", "Скелетен систем"),
            2: ("bio8-2-2.py", "Bio822Scene", "Градба на коски"),
            3: ("bio8-2-3.py", "Bio823Scene", "Зглобови — видови"),
            4: ("bio8-2-4.py", "Bio824Scene", "Мускули и нивна градба"),
            5: ("bio8-2-5.py", "Bio825Scene", "Дејство на мускулите — парови антагонисти"),
            6: ("bio8-2-6.py", "Bio826Scene", "Движење — координација на скелет и мускули"),
            7: ("bio8-2-7.py", "Bio827Scene", "Држечка положба, повреди и здравје на мускули"),
        },
        3: {
            1: ("bio8-3-1.py", "Bio831Scene", "Составни делови на избалансирана исхрана"),
            2: ("bio8-3-2.py", "Bio832Scene", "Количина на енергија во храна"),
            3: ("bio8-3-3.py", "Bio833Scene", "Тестирање на јаглехидрати и масти"),
            4: ("bio8-3-4.py", "Bio834Scene", "Белковини — важност и извори"),
            5: ("bio8-3-5.py", "Bio835Scene", "Неухранетост и ефекти"),
            6: ("bio8-3-6.py", "Bio836Scene", "Дигестивен систем — патување низ телото"),
            7: ("bio8-3-7.py", "Bio837Scene", "Физичко и хемиско варење"),
            8: ("bio8-3-8.py", "Bio838Scene", "Ензими и температура"),
        },
        4: {
            1: ("bio8-4-1.py", "Bio841Scene", "Видови на циркулација"),
            2: ("bio8-4-2.py", "Bio842Scene", "Срце — анатомија и функција"),
            3: ("bio8-4-3.py", "Bio843Scene", "Крвни садови"),
            4: ("bio8-4-4.py", "Bio844Scene", "Состав на крвта"),
            5: ("bio8-4-5.py", "Bio845Scene", "Истражување — пулс и вежбање"),
            6: ("bio8-4-6.py", "Bio846Scene", "Вилијам Харви и откривање на циркулација"),
            7: ("bio8-4-7.py", "Bio847Scene", "Крвни групи и трансфузија"),
        },
        5: {
            1: ("bio8-5-1.py", "Bio851Scene", "Што е вид? Дефиниција и видови варијација"),
            2: ("bio8-5-2.py", "Bio852Scene", "Гени и наследување — основи"),
            3: ("bio8-5-3.py", "Bio853Scene", "Мерење на варијација кај луѓе"),
            4: ("bio8-5-4.py", "Bio854Scene", "Истражување на варијација кај растенија"),
            5: ("bio8-5-5.py", "Bio855Scene", "Адаптации — преживување во средината"),
            6: ("bio8-5-6.py", "Bio856Scene", "Природна селекција — Дарвин"),
        },
        6: {
            1: ("bio8-6-1.py", "Bio861Scene", "Зошто класифицираме?"),
            2: ("bio8-6-2.py", "Bio862Scene", "Подредување на 'рбетници"),
            3: ("bio8-6-3.py", "Bio863Scene", "Подредување на без'рбетници"),
            4: ("bio8-6-4.py", "Bio864Scene", "Растенија — главни групи"),
            5: ("bio8-6-5.py", "Bio865Scene", "Биодиверзитет и зачувување"),
        },
        7: {
            1: ("bio8-7-1.py", "Bio871Scene", "Што се фосили?"),
            2: ("bio8-7-2.py", "Bio872Scene", "Изработка на модел на фосил"),
            3: ("bio8-7-3.py", "Bio873Scene", "Записи од фосили и староста на Земјата"),
        },
    },
    "chemistry": {
        1: {
