...
Lesson: phys8-1-5 — Графикони брзина-време и забрзување
...
class Phys15Scene(Scene):
    """
    phys8-1-5 — Графикони брзина-време и забрзување
    ...
    def hook(self):
        ...
        title = Text(
            "Графикони брзина-време и забрзување",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Графикони брзина-време и забрзување!",
            font="Noto Sans",
            font_size=36,
...
class Phys15Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Графикони брзина-време и забрзување (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-1-5")
    print(f"To render: manim -ql phys8-1-5.py Phys15Scene")
    print(f"For 3D: manim -ql phys8-1-5.py Phys15Scene3D")
