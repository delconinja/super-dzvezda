...
Lesson: chem8-3-6 — Разделување смеси — практични примери
...
class Chem36Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Разделување смеси — практични примери",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Разделување смеси — практични примери!",
            font="Noto Sans",
            font_size=36,
...
class Chem36Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Разделување смеси — практични примери (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-3-6")
    print(f"To render: manim -ql chem8-3-6.py Chem36Scene")
    print(f"For 3D: manim -ql chem8-3-6.py Chem36Scene3D")
