...
Lesson: bio8-5-2 — Гени и наследување — основи
...
class Bio52Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Гени и наследување — основи!",
            font="Noto Sans",
            font_size=36,
...
class Bio52Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-5-2")
    print(f"To render: manim -ql bio8-5-2.py Bio52Scene")
    print(f"For 3D: manim -ql bio8-5-2.py Bio52Scene3D")
