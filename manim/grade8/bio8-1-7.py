...
Lesson: bio8-1-7 — Ендокрин систем и хормонална регулација
...
class Bio17Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Ендокрин систем и хормонална регулација!",
            font="Noto Sans",
            font_size=36,
...
class Bio17Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Ендокрин систем и хормонална регулација (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-1-7")
    print(f"To render: manim -ql bio8-1-7.py Bio17Scene")
    print(f"For 3D: manim -ql bio8-1-7.py Bio17Scene3D")
