...
Lesson: chem8-4-7 — Рѓосување и заштита од корозија
...
class Chem47Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Рѓосување и заштита од корозија",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Рѓосување и заштита од корозија!",
            font="Noto Sans",
            font_size=36,
...
class Chem47Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Рѓосување и заштита од корозија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-4-7")
    print(f"To render: manim -ql chem8-4-7.py Chem47Scene")
    print(f"For 3D: manim -ql chem8-4-7.py Chem47Scene3D")
