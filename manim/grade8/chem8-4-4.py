...
Lesson: chem8-4-4 — Хидроксиди и реакции со вода
...
class Chem44Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Хидроксиди и реакции со вода!",
            font="Noto Sans",
            font_size=36,
...
class Chem44Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Хидроксиди и реакции со вода (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-4-4")
    print(f"To render: manim -ql chem8-4-4.py Chem44Scene")
    print(f"For 3D: manim -ql chem8-4-4.py Chem44Scene3D")
