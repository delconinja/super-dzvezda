...
Lesson: bio8-5-3 — Мерење на варијација кај луѓе
...
class Bio53Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Мерење на варијација кај луѓе!",
            font="Noto Sans",
            font_size=36,
...
class Bio53Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Мерење на варијација кај луѓе (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-5-3")
    print(f"To render: manim -ql bio8-5-3.py Bio53Scene")
    print(f"For 3D: manim -ql bio8-5-3.py Bio53Scene3D")
