...
Lesson: m8-1-2 — Вредност, подредување и заокружување
...
class Math12Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Вредност, подредување и заокружување",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Вредност, подредување и заокружување!",
            font="Noto Sans",
            font_size=36,
...
class Math12Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Вредност, подредување и заокружување (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-1-2")
    print(f"To render: manim -ql m8-1-2.py Math12Scene")
    print(f"For 3D: manim -ql m8-1-2.py Math12Scene3D")
