...
Lesson: bio8-2-6 — Движење — координација на скелет и мускули
...
class Bio26Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Движење — координација на скелет и мускули",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Движење — координација на скелет и мускули!",
            font="Noto Sans",
            font_size=36,
...
class Bio26Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Движење — координација на скелет и мускули (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-2-6")
    print(f"To render: manim -ql bio8-2-6.py Bio26Scene")
    print(f"For 3D: manim -ql bio8-2-6.py Bio26Scene3D")
