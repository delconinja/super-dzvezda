...
class Bio43Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Крвни садови!",
            font="Noto Sans",
            font_size=36,
...
class Bio43Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-4-3")
    print(f"To render: manim -ql bio8-4-3.py Bio43Scene")
    print(f"For 3D: manim -ql bio8-4-3.py Bio43Scene3D")
