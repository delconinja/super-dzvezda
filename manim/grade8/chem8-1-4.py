...
class Chem14Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Дифузија!",
            font="Noto Sans",
            font_size=36,
...
class Chem14Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-1-4")
    print(f"To render: manim -ql chem8-1-4.py Chem14Scene")
    print(f"For 3D: manim -ql chem8-1-4.py Chem14Scene3D")
