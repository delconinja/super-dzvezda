...
Lesson: bio8-2-1 — Скелетен систем
...
class Bio21Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Скелетен систем!",
            font="Noto Sans",
            font_size=36,
...
class Bio21Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-2-1")
    print(f"To render: manim -ql bio8-2-1.py Bio21Scene")
    print(f"For 3D: manim -ql bio8-2-1.py Bio21Scene3D")
