...
Lesson: geo8-6-1 — Германија — водечка држава на Европа
...
class Geo61Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Германија — водечка држава на Европа",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Германија — водечка држава на Европа!",
            font="Noto Sans",
            font_size=36,
...
class Geo61Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Германија — водечка држава на Европа (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-6-1")
    print(f"To render: manim -ql geo8-6-1.py Geo61Scene")
    print(f"For 3D: manim -ql geo8-6-1.py Geo61Scene3D")
