...
Lesson: geo8-2-1 — Население на Европа
...
class Geo21Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Население на Европа!",
            font="Noto Sans",
            font_size=36,
...
class Geo21Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-2-1")
    print(f"To render: manim -ql geo8-2-1.py Geo21Scene")
    print(f"For 3D: manim -ql geo8-2-1.py Geo21Scene3D")
