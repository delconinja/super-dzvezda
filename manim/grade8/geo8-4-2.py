...
Lesson: geo8-4-2 — Франција и Бенелукс
...
class Geo42Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Франција и Бенелукс!",
            font="Noto Sans",
            font_size=36,
...
class Geo42Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-4-2")
    print(f"To render: manim -ql geo8-4-2.py Geo42Scene")
    print(f"For 3D: manim -ql geo8-4-2.py Geo42Scene3D")
