...
Lesson: chem8-5-4 — Согорување на горива и животна средина
...
class Chem54Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Согорување на горива и животна средина",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Согорување на горива и животна средина!",
            font="Noto Sans",
            font_size=36,
...
class Chem54Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Согорување на горива и животна средина (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-5-4")
    print(f"To render: manim -ql chem8-5-4.py Chem54Scene")
    print(f"For 3D: manim -ql chem8-5-4.py Chem54Scene3D")
