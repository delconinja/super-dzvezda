...
Lesson: m8-2-2 — Низи, функции и графици
...
class Math22Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Низи, функции и графици!",
            font="Noto Sans",
            font_size=36,
...
class Math22Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-2-2")
    print(f"To render: manim -ql m8-2-2.py Math22Scene")
    print(f"For 3D: manim -ql m8-2-2.py Math22Scene3D")
