...
Lesson: geo8-4-1 — Велика Британија и Ирска
...
class Geo41Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Велика Британија и Ирска!",
            font="Noto Sans",
            font_size=36,
...
class Geo41Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-4-1")
    print(f"To render: manim -ql geo8-4-1.py Geo41Scene")
    print(f"For 3D: manim -ql geo8-4-1.py Geo41Scene3D")
