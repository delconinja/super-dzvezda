...
Lesson: phys8-2-3 — Енергијата во телото
...
class Phys23Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Енергијата во телото!",
            font="Noto Sans",
            font_size=36,
...
class Phys23Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-2-3")
    print(f"To render: manim -ql phys8-2-3.py Phys23Scene")
    print(f"For 3D: manim -ql phys8-2-3.py Phys23Scene3D")
