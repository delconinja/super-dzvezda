...
Lesson: bio8-5-1 — Што е вид? Дефиниција и видови варијација
...
class Bio51Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Што е вид? Дефиниција и видови варијација",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Што е вид? Дефиниција и видови варијација!",
            font="Noto Sans",
            font_size=36,
...
class Bio51Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Што е вид? Дефиниција и видови варијација (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-5-1")
    print(f"To render: manim -ql bio8-5-1.py Bio51Scene")
    print(f"For 3D: manim -ql bio8-5-1.py Bio51Scene3D")
