...
Lesson: phys8-3-4 — Рефракција (прелом) на светлина
...
class Phys34Scene(Scene):
    """
    phys8-3-4 — Рефракција (прелом) на светлина
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Рефракција (прелом) на светлина!",
            font="Noto Sans",
            font_size=36,
...
class Phys34Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Рефракција (прелом) на светлина (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-3-4")
    print(f"To render: manim -ql phys8-3-4.py Phys34Scene")
    print(f"For 3D: manim -ql phys8-3-4.py Phys34Scene3D")
