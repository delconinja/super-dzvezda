...
Lesson: chem8-2-5 — Периоден систем и групи на елементите
...
class Chem25Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Периоден систем и групи на елементите",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Периоден систем и групи на елементите!",
            font="Noto Sans",
            font_size=36,
...
class Chem25Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Периоден систем и групи на елементите (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-2-5")
    print(f"To render: manim -ql chem8-2-5.py Chem25Scene")
    print(f"For 3D: manim -ql chem8-2-5.py Chem25Scene3D")
