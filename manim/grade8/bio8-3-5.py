...
Lesson: bio8-3-5 — Неухранетост и ефекти
...
class Bio35Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Неухранетост и ефекти!",
            font="Noto Sans",
            font_size=36,
...
class Bio35Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-3-5")
    print(f"To render: manim -ql bio8-3-5.py Bio35Scene")
    print(f"For 3D: manim -ql bio8-3-5.py Bio35Scene3D")
