...
Lesson: phys8-4-5 — Месечина — единствен природен сателит
...
class Phys45Scene(Scene):
    """
    phys8-4-5 — Месечина — единствен природен сателит
    ...
    def hook(self):
        ...
        title = Text(
            "Месечина — единствен природен сателит",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Месечина — единствен природен сателит!",
            font="Noto Sans",
            font_size=36,
...
class Phys45Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Месечина — единствен природен сателит (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-4-5")
    print(f"To render: manim -ql phys8-4-5.py Phys45Scene")
    print(f"For 3D: manim -ql phys8-4-5.py Phys45Scene3D")
