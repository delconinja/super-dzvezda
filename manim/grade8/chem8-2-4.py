...
Lesson: chem8-2-4 — Метали и легури
...
class Chem24Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Метали и легури!",
            font="Noto Sans",
            font_size=36,
...
class Chem24Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-2-4")
    print(f"To render: manim -ql chem8-2-4.py Chem24Scene")
    print(f"For 3D: manim -ql chem8-2-4.py Chem24Scene3D")
