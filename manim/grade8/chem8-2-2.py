...
Lesson: chem8-2-2 — Споредување материјали
...
class Chem22Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Споредување материјали!",
            font="Noto Sans",
            font_size=36,
...
class Chem22Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-2-2")
    print(f"To render: manim -ql chem8-2-2.py Chem22Scene")
    print(f"For 3D: manim -ql chem8-2-2.py Chem22Scene3D")
