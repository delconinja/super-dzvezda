...
Lesson: m8-2-1 — Изрази, равенки и формули
...
class Math21Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Изрази, равенки и формули!",
            font="Noto Sans",
            font_size=36,
...
class Math21Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-2-1")
    print(f"To render: manim -ql m8-2-1.py Math21Scene")
    print(f"For 3D: manim -ql m8-2-1.py Math21Scene3D")
