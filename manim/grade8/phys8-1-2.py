...
Lesson: phys8-1-2 — Сили и промена на облик
...
class Phys12Scene(Scene):
    """
    phys8-1-2 — Сили и промена на облик
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Сили и промена на облик!",
            font="Noto Sans",
            font_size=36,
...
class Phys12Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-1-2")
    print(f"To render: manim -ql phys8-1-2.py Phys12Scene")
    print(f"For 3D: manim -ql phys8-1-2.py Phys12Scene3D")
