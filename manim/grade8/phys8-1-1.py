...
Lesson: phys8-1-1 — Што прават силите?
...
class Phys11Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Што прават силите?!",
            font="Noto Sans",
            font_size=36,
...
class Phys11Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-1-1")
    print(f"To render: manim -ql phys8-1-1.py Phys11Scene")
    print(f"For 3D: manim -ql phys8-1-1.py Phys11Scene3D")
