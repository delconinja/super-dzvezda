...
Lesson: bio8-1-1 — Повторување за органски системи
...
class Bio11Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Повторување за органски системи",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Повторување за органски системи!",
            font="Noto Sans",
            font_size=36,
...
class Bio11Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Повторување за органски системи (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-1-1")
    print(f"To render: manim -ql bio8-1-1.py Bio11Scene")
    print(f"For 3D: manim -ql bio8-1-1.py Bio11Scene3D")
