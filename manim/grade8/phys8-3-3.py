...
Lesson: phys8-3-3 — Рефлексија и закон за рефлексија
...
class Phys33Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Рефлексија и закон за рефлексија",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Рефлексија и закон за рефлексија!",
            font="Noto Sans",
            font_size=36,
...
class Phys33Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Рефлексија и закон за рефлексија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-3-3")
    print(f"To render: manim -ql phys8-3-3.py Phys33Scene")
    print(f"For 3D: manim -ql phys8-3-3.py Phys33Scene3D")
