...
Lesson: geo8-7-2 — Украина, Белорусија и Молдавија
...
class Geo72Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Украина, Белорусија и Молдавија!",
            font="Noto Sans",
            font_size=36,
...
class Geo72Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Украина, Белорусија и Молдавија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-7-2")
    print(f"To render: manim -ql geo8-7-2.py Geo72Scene")
    print(f"For 3D: manim -ql geo8-7-2.py Geo72Scene3D")
