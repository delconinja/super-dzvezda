...
Lesson: phys8-2-2 — Пренесување на енергија
...
class Phys22Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Пренесување на енергија!",
            font="Noto Sans",
            font_size=36,
...
class Phys22Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-2-2")
    print(f"To render: manim -ql phys8-2-2.py Phys22Scene")
    print(f"For 3D: manim -ql phys8-2-2.py Phys22Scene3D")
