...
Lesson: m8-3-1 — Форми и геометриско размислување
...
class Math31Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Форми и геометриско размислување",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Форми и геометриско размислување!",
            font="Noto Sans",
            font_size=36,
...
class Math31Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Форми и геометриско размислување (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-3-1")
    print(f"To render: manim -ql m8-3-1.py Math31Scene")
    print(f"For 3D: manim -ql m8-3-1.py Math31Scene3D")
