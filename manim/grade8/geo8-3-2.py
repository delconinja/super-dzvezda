...
Lesson: geo8-3-2 — Италија и Апенински Полуостров
...
class Geo32Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Италија и Апенински Полуостров",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Италија и Апенински Полуостров!",
            font="Noto Sans",
            font_size=36,
...
class Geo32Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Италија и Апенински Полуостров (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-3-2")
    print(f"To render: manim -ql geo8-3-2.py Geo32Scene")
    print(f"For 3D: manim -ql geo8-3-2.py Geo32Scene3D")
