...
Lesson: bio8-1-6 — Рецептори во кожата
...
class Bio16Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Рецептори во кожата!",
            font="Noto Sans",
            font_size=36,
...
class Bio16Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-1-6")
    print(f"To render: manim -ql bio8-1-6.py Bio16Scene")
    print(f"For 3D: manim -ql bio8-1-6.py Bio16Scene3D")
