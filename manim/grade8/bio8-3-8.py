...
Lesson: bio8-3-8 — Ензими и температура
...
class Bio38Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Ензими и температура!",
            font="Noto Sans",
            font_size=36,
...
class Bio38Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-3-8")
    print(f"To render: manim -ql bio8-3-8.py Bio38Scene")
    print(f"For 3D: manim -ql bio8-3-8.py Bio38Scene3D")
