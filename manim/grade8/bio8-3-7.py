...
Lesson: bio8-3-7 — Физичко и хемиско варење
...
class Bio37Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Физичко и хемиско варење!",
            font="Noto Sans",
            font_size=36,
...
class Bio37Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-3-7")
    print(f"To render: manim -ql bio8-3-7.py Bio37Scene")
    print(f"For 3D: manim -ql bio8-3-7.py Bio37Scene3D")
