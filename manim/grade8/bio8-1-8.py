...
Lesson: bio8-1-8 — Систем за излачување
...
class Bio18Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Систем за излачување!",
            font="Noto Sans",
            font_size=36,
...
class Bio18Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-1-8")
    print(f"To render: manim -ql bio8-1-8.py Bio18Scene")
    print(f"For 3D: manim -ql bio8-1-8.py Bio18Scene3D")
