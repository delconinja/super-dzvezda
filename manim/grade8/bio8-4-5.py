...
Lesson: bio8-4-5 — Истражување — пулс и вежбање
...
class Bio45Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Истражување — пулс и вежбање!",
            font="Noto Sans",
            font_size=36,
...
class Bio45Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-4-5")
    print(f"To render: manim -ql bio8-4-5.py Bio45Scene")
    print(f"For 3D: manim -ql bio8-4-5.py Bio45Scene3D")
