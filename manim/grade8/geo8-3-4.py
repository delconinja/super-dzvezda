...
Lesson: geo8-3-4 — Западен Балкан: Хрватска, Словенија, БиХ, Црна Гора
...
class Geo34Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Западен Балкан: Хрватска, Словенија, БиХ, Црна Гора",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Западен Балкан: Хрватска, Словенија, БиХ, Црна Гора!",
            font="Noto Sans",
            font_size=36,
...
class Geo34Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Западен Балкан: Хрватска, Словенија, БиХ, Црна Гора (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-3-4")
    print(f"To render: manim -ql geo8-3-4.py Geo34Scene")
    print(f"For 3D: manim -ql geo8-3-4.py Geo34Scene3D")
