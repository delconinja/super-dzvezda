...
Lesson: chem8-4-6 — Реакции на неутрализација
...
class Chem46Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Реакции на неутрализација!",
            font="Noto Sans",
            font_size=36,
...
class Chem46Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-4-6")
    print(f"To render: manim -ql chem8-4-6.py Chem46Scene")
    print(f"For 3D: manim -ql chem8-4-6.py Chem46Scene3D")
