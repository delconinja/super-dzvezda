...
Lesson: chem8-1-3 — Гасен притисок
...
class Chem13Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Гасен притисок!",
            font="Noto Sans",
            font_size=36,
...
class Chem13Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-1-3")
    print(f"To render: manim -ql chem8-1-3.py Chem13Scene")
    print(f"For 3D: manim -ql chem8-1-3.py Chem13Scene3D")
