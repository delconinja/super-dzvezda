...
Lesson: geo8-1-4 — Хидрографија и природни ресурси
...
class Geo14Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Хидрографија и природни ресурси",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Хидрографија и природни ресурси!",
            font="Noto Sans",
            font_size=36,
...
class Geo14Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Хидрографија и природни ресурси (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-1-4")
    print(f"To render: manim -ql geo8-1-4.py Geo14Scene")
    print(f"For 3D: manim -ql geo8-1-4.py Geo14Scene3D")
