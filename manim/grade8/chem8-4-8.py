...
Lesson: chem8-4-8 — Киселини и бази во секојдневие
...
class Chem48Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Киселини и бази во секојдневие",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Киселини и бази во секојдневие!",
            font="Noto Sans",
            font_size=36,
...
class Chem48Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Киселини и бази во секојдневие (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-4-8")
    print(f"To render: manim -ql chem8-4-8.py Chem48Scene")
    print(f"For 3D: manim -ql chem8-4-8.py Chem48Scene3D")
