...
Lesson: chem8-3-5 — Прости супстанци, соединенија и смеси
...
class Chem35Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Прости супстанци, соединенија и смеси",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Прости супстанци, соединенија и смеси!",
            font="Noto Sans",
            font_size=36,
...
class Chem35Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Прости супстанци, соединенија и смеси (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-3-5")
    print(f"To render: manim -ql chem8-3-5.py Chem35Scene")
    print(f"For 3D: manim -ql chem8-3-5.py Chem35Scene3D")
