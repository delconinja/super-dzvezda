...
Lesson: bio8-6-4 — Растенија — главни групи
...
class Bio64Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Растенија — главни групи!",
            font="Noto Sans",
            font_size=36,
...
class Bio64Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-6-4")
    print(f"To render: manim -ql bio8-6-4.py Bio64Scene")
    print(f"For 3D: manim -ql bio8-6-4.py Bio64Scene3D")
