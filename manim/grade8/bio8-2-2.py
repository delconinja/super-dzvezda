...
Lesson: bio8-2-2 — Градба на коски
...
class Bio22Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Градба на коски!",
            font="Noto Sans",
            font_size=36,
...
class Bio22Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-2-2")
    print(f"To render: manim -ql bio8-2-2.py Bio22Scene")
    print(f"For 3D: manim -ql bio8-2-2.py Bio22Scene3D")
