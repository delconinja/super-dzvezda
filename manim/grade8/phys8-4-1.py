...
class Phys41Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Ден и ноќ!",
            font="Noto Sans",
            font_size=36,
...
class Phys41Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-4-1")
    print(f"To render: manim -ql phys8-4-1.py Phys41Scene")
    print(f"For 3D: manim -ql phys8-4-1.py Phys41Scene3D")
