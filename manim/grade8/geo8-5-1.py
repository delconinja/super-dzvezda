...
Lesson: geo8-5-1 — Скандинавски земји
...
class Geo51Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Скандинавски земји!",
            font="Noto Sans",
            font_size=36,
...
class Geo51Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-5-1")
    print(f"To render: manim -ql geo8-5-1.py Geo51Scene")
    print(f"For 3D: manim -ql geo8-5-1.py Geo51Scene3D")
