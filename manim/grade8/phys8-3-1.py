...
Lesson: phys8-3-1 — Само-светлечки и несветлечки предмети
...
class Phys31Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Само-светлечки и несветлечки предмети",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Само-светлечки и несветлечки предмети!",
            font="Noto Sans",
            font_size=36,
...
class Phys31Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Само-светлечки и несветлечки предмети (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-3-1")
    print(f"To render: manim -ql phys8-3-1.py Phys31Scene")
    print(f"For 3D: manim -ql phys8-3-1.py Phys31Scene3D")
