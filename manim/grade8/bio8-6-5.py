...
Lesson: bio8-6-5 — Биодиверзитет и зачувување
...
class Bio65Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Биодиверзитет и зачувување!",
            font="Noto Sans",
            font_size=36,
...
class Bio65Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-6-5")
    print(f"To render: manim -ql bio8-6-5.py Bio65Scene")
    print(f"For 3D: manim -ql bio8-6-5.py Bio65Scene3D")
