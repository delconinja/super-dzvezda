...
Lesson: bio8-7-3 — Записи од фосили и староста на Земјата
...
class Bio73Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Записи од фосили и староста на Земјата",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Записи од фосили и староста на Земјата!",
            font="Noto Sans",
            font_size=36,
...
class Bio73Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Записи од фосили и староста на Земјата (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-7-3")
    print(f"To render: manim -ql bio8-7-3.py Bio73Scene")
    print(f"For 3D: manim -ql bio8-7-3.py Bio73Scene3D")
