...
Lesson: chem8-2-3 — Метали и неметали во периодниот систем
...
class Chem23Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Метали и неметали во периодниот систем",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Метали и неметали во периодниот систем!",
            font="Noto Sans",
            font_size=36,
...
class Chem23Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Метали и неметали во периодниот систем (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-2-3")
    print(f"To render: manim -ql chem8-2-3.py Chem23Scene")
    print(f"For 3D: manim -ql chem8-2-3.py Chem23Scene3D")
