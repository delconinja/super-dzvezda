...
Lesson: phys8-1-6 — Сили и движење
...
class Phys16Scene(Scene):
    """
    phys8-1-6 — Сили и движење
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Сили и движење!",
            font="Noto Sans",
            font_size=36,
...
class Phys16Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-1-6")
    print(f"To render: manim -ql phys8-1-6.py Phys16Scene")
    print(f"For 3D: manim -ql phys8-1-6.py Phys16Scene3D")
