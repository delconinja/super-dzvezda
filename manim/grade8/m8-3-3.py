...
Lesson: m8-3-3 — Плоштина, периметар и зафатнина
...
class Math33Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Плоштина, периметар и зафатнина",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Плоштина, периметар и зафатнина!",
            font="Noto Sans",
            font_size=36,
...
class Math33Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Плоштина, периметар и зафатнина (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-3-3")
    print(f"To render: manim -ql m8-3-3.py Math33Scene")
    print(f"For 3D: manim -ql m8-3-3.py Math33Scene3D")
