...
class Phys17Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Триење!",
            font="Noto Sans",
            font_size=36,
...
class Phys17Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-1-7")
    print(f"To render: manim -ql phys8-1-7.py Phys17Scene")
    print(f"For 3D: manim -ql phys8-1-7.py Phys17Scene3D")
