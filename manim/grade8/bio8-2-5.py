...
Lesson: bio8-2-5 — Дејство на мускулите — парови антагонисти
...
class Bio25Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Дејство на мускулите — парови антагонисти",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Дејство на мускулите — парови антагонисти!",
            font="Noto Sans",
            font_size=36,
...
class Bio25Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Дејство на мускулите — парови антагонисти (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-2-5")
    print(f"To render: manim -ql bio8-2-5.py Bio25Scene")
    print(f"For 3D: manim -ql bio8-2-5.py Bio25Scene3D")
