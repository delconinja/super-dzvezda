...
Lesson: chem8-2-1 — Секојдневни материјали и нивните својства
...
class Chem21Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Секојдневни материјали и нивните својства",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Секојдневни материјали и нивните својства!",
            font="Noto Sans",
            font_size=36,
...
class Chem21Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Секојдневни материјали и нивните својства (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-2-1")
    print(f"To render: manim -ql chem8-2-1.py Chem21Scene")
    print(f"For 3D: manim -ql chem8-2-1.py Chem21Scene3D")
