...
class Math54Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Веројатност!",
            font="Noto Sans",
            font_size=36,
...
class Math54Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-5-4")
    print(f"To render: manim -ql m8-5-4.py Math54Scene")
    print(f"For 3D: manim -ql m8-5-4.py Math54Scene3D")
