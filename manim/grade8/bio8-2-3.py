...
Lesson: bio8-2-3 — Зглобови — видови
...
class Bio23Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Зглобови — видови!",
            font="Noto Sans",
            font_size=36,
...
class Bio23Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-2-3")
    print(f"To render: manim -ql bio8-2-3.py Bio23Scene")
    print(f"For 3D: manim -ql bio8-2-3.py Bio23Scene3D")
