...
Lesson: phys8-4-2 — Годишни времиња
...
class Phys42Scene(Scene):
    """
    phys8-4-2 — Годишни времиња
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Годишни времиња!",
            font="Noto Sans",
            font_size=36,
...
class Phys42Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-4-2")
    print(f"To render: manim -ql phys8-4-2.py Phys42Scene")
    print(f"For 3D: manim -ql phys8-4-2.py Phys42Scene3D")
