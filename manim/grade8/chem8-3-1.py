...
Lesson: chem8-3-1 — Елементи и атоми
...
class Chem31Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Елементи и атоми!",
            font="Noto Sans",
            font_size=36,
...
class Chem31Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-3-1")
    print(f"To render: manim -ql chem8-3-1.py Chem31Scene")
    print(f"For 3D: manim -ql chem8-3-1.py Chem31Scene3D")
