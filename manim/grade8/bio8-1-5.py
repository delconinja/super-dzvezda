...
Lesson: bio8-1-5 — Рецептори за звук — увото
...
class Bio15Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Рецептори за звук — увото!",
            font="Noto Sans",
            font_size=36,
...
class Bio15Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-1-5")
    print(f"To render: manim -ql bio8-1-5.py Bio15Scene")
    print(f"For 3D: manim -ql bio8-1-5.py Bio15Scene3D")
