...
Lesson: bio8-4-1 — Видови на циркулација
...
class Bio41Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Видови на циркулација!",
            font="Noto Sans",
            font_size=36,
...
class Bio41Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-4-1")
    print(f"To render: manim -ql bio8-4-1.py Bio41Scene")
    print(f"For 3D: manim -ql bio8-4-1.py Bio41Scene3D")
