...
Lesson: geo8-5-2 — Балтички држави: Естонија, Латвија, Литванија
...
class Geo52Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Балтички држави: Естонија, Латвија, Литванија",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Балтички држави: Естонија, Латвија, Литванија!",
            font="Noto Sans",
            font_size=36,
...
class Geo52Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Балтички држави: Естонија, Латвија, Литванија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-5-2")
    print(f"To render: manim -ql geo8-5-2.py Geo52Scene")
    print(f"For 3D: manim -ql geo8-5-2.py Geo52Scene3D")
