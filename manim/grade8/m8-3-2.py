...
Lesson: m8-3-2 — Положба и движење
...
class Math32Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Положба и движење!",
            font="Noto Sans",
            font_size=36,
...
class Math32Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-3-2")
    print(f"To render: manim -ql m8-3-2.py Math32Scene")
    print(f"For 3D: manim -ql m8-3-2.py Math32Scene3D")
