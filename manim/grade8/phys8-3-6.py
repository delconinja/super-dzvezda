...
Lesson: phys8-3-6 — Леќи и окото — оптика во медицинa
...
class Phys36Scene(Scene):
    """
    phys8-3-6 — Леќи и окото — оптика во медицинa
    ...
    def hook(self):
        ...
        title = Text(
            "Леќи и окото — оптика во медицинa",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Леќи и окото — оптика во медицинa!",
            font="Noto Sans",
            font_size=36,
...
class Phys36Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Леќи и окото — оптика во медицинa (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-3-6")
    print(f"To render: manim -ql phys8-3-6.py Phys36Scene")
    print(f"For 3D: manim -ql phys8-3-6.py Phys36Scene3D")
