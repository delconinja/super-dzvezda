...
Lesson: chem8-1-2 — Промени на агрегатната состојба
...
class Chem12Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Промени на агрегатната состојба",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Промени на агрегатната состојба!",
            font="Noto Sans",
            font_size=36,
...
class Chem12Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Промени на агрегатната состојба (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-1-2")
    print(f"To render: manim -ql chem8-1-2.py Chem12Scene")
    print(f"For 3D: manim -ql chem8-1-2.py Chem12Scene3D")
