...
Lesson: bio8-5-5 — Адаптации — преживување во средината
...
class Bio55Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Адаптации — преживување во средината",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Адаптации — преживување во средината!",
            font="Noto Sans",
            font_size=36,
...
class Bio55Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Адаптации — преживување во средината (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-5-5")
    print(f"To render: manim -ql bio8-5-5.py Bio55Scene")
    print(f"For 3D: manim -ql bio8-5-5.py Bio55Scene3D")
