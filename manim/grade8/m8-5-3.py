...
Lesson: m8-5-3 — Толкување и дискутирање за резултатите
...
class Math53Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Толкување и дискутирање за резултатите",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Толкување и дискутирање за резултатите!",
            font="Noto Sans",
            font_size=36,
...
class Math53Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Толкување и дискутирање за резултатите (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-5-3")
    print(f"To render: manim -ql m8-5-3.py Math53Scene")
    print(f"For 3D: manim -ql m8-5-3.py Math53Scene3D")
