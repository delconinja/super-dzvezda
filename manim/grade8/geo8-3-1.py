...
Lesson: geo8-3-1 — Балкански Полуостров
...
class Geo31Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Балкански Полуостров!",
            font="Noto Sans",
            font_size=36,
...
class Geo31Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-3-1")
    print(f"To render: manim -ql geo8-3-1.py Geo31Scene")
    print(f"For 3D: manim -ql geo8-3-1.py Geo31Scene3D")
