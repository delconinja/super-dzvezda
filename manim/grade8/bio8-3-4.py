...
Lesson: bio8-3-4 — Белковини — важност и извори
...
class Bio34Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Белковини — важност и извори!",
            font="Noto Sans",
            font_size=36,
...
class Bio34Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-3-4")
    print(f"To render: manim -ql bio8-3-4.py Bio34Scene")
    print(f"For 3D: manim -ql bio8-3-4.py Bio34Scene3D")
