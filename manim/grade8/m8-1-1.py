...
Lesson: m8-1-1 — Цели броеви, степени и корени
...
class Math11Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Цели броеви, степени и корени!",
            font="Noto Sans",
            font_size=36,
...
class Math11Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Цели броеви, степени и корени (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-1-1")
    print(f"To render: manim -ql m8-1-1.py Math11Scene")
    print(f"For 3D: manim -ql m8-1-1.py Math11Scene3D")
