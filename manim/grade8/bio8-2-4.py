...
Lesson: bio8-2-4 — Мускули и нивна градба
...
class Bio24Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Мускули и нивна градба!",
            font="Noto Sans",
            font_size=36,
...
class Bio24Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-2-4")
    print(f"To render: manim -ql bio8-2-4.py Bio24Scene")
    print(f"For 3D: manim -ql bio8-2-4.py Bio24Scene3D")
