...
class Phys18Scene(Scene):
    """
    phys8-1-8 — Гравитација
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Гравитација!",
            font="Noto Sans",
            font_size=36,
...
class Phys18Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-1-8")
    print(f"To render: manim -ql phys8-1-8.py Phys18Scene")
    print(f"For 3D: manim -ql phys8-1-8.py Phys18Scene3D")
