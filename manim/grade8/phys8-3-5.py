...
Lesson: phys8-3-5 — Бои и дисперзија
...
class Phys35Scene(Scene):
    """
    phys8-3-5 — Бои и дисперзија
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Бои и дисперзија!",
            font="Noto Sans",
            font_size=36,
...
class Phys35Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-3-5")
    print(f"To render: manim -ql phys8-3-5.py Phys35Scene")
    print(f"For 3D: manim -ql phys8-3-5.py Phys35Scene3D")
