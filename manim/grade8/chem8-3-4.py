...
Lesson: chem8-3-4 — Хемиски формули
...
class Chem34Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Хемиски формули!",
            font="Noto Sans",
            font_size=36,
...
class Chem34Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-3-4")
    print(f"To render: manim -ql chem8-3-4.py Chem34Scene")
    print(f"For 3D: manim -ql chem8-3-4.py Chem34Scene3D")
