...
Lesson: geo8-1-3 — Клима на Европа
...
class Geo13Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Клима на Европа!",
            font="Noto Sans",
            font_size=36,
...
class Geo13Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-1-3")
    print(f"To render: manim -ql geo8-1-3.py Geo13Scene")
    print(f"For 3D: manim -ql geo8-1-3.py Geo13Scene3D")
