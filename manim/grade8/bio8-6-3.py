...
Lesson: bio8-6-3 — Подредување на безрбетници
...
class Bio63Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Подредување на безрбетници!",
            font="Noto Sans",
            font_size=36,
...
class Bio63Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-6-3")
    print(f"To render: manim -ql bio8-6-3.py Bio63Scene")
    print(f"For 3D: manim -ql bio8-6-3.py Bio63Scene3D")
