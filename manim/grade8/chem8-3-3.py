...
Lesson: chem8-3-3 — Што е соединение?
...
class Chem33Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Што е соединение?!",
            font="Noto Sans",
            font_size=36,
...
class Chem33Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-3-3")
    print(f"To render: manim -ql chem8-3-3.py Chem33Scene")
    print(f"For 3D: manim -ql chem8-3-3.py Chem33Scene3D")
