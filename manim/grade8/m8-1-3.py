...
Lesson: m8-1-3 — Дропки, децимални броеви, проценти, размери и пропорции
...
class Math13Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Дропки, децимални броеви, проценти, размери и пропорции",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
        ...
        subtitle = Text(
            "A cinematic journey through Mathematics...",
            font="Noto Sans",
            font_size=24,
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Дропки, децимални броеви, проценти, размери и пропорции!",
            font="Noto Sans",
            font_size=36,
...
class Math13Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Дропки, децимални броеви, проценти, размери и пропорции (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-1-3")
    print(f"To render: manim -ql m8-1-3.py Math13Scene")
    print(f"For 3D: manim -ql m8-1-3.py Math13Scene3D")
