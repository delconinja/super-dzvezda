...
Lesson: m8-5-2 — Обработка и претставување на податоци
...
class Math52Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Обработка и претставување на податоци",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Обработка и претставување на податоци!",
            font="Noto Sans",
            font_size=36,
...
class Math52Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Обработка и претставување на податоци (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-5-2")
    print(f"To render: manim -ql m8-5-2.py Math52Scene")
    print(f"For 3D: manim -ql m8-5-2.py Math52Scene3D")
