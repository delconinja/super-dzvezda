...
Lesson: m8-5-1 — Планирање и собирање податоци
...
class Math51Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Планирање и собирање податоци!",
            font="Noto Sans",
            font_size=36,
...
class Math51Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Планирање и собирање податоци (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-5-1")
    print(f"To render: manim -ql m8-5-1.py Math51Scene")
    print(f"For 3D: manim -ql m8-5-1.py Math51Scene3D")
