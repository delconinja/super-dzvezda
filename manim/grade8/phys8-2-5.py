...
Lesson: phys8-2-5 — Искористување и губење на енергија
...
class Phys25Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Искористување и губење на енергија",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Искористување и губење на енергија!",
            font="Noto Sans",
            font_size=36,
...
class Phys25Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Искористување и губење на енергија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-2-5")
    print(f"To render: manim -ql phys8-2-5.py Phys25Scene")
    print(f"For 3D: manim -ql phys8-2-5.py Phys25Scene3D")
