...
Lesson: bio8-4-2 — Срце — анатомија и функција
...
class Bio42Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Срце — анатомија и функција!",
            font="Noto Sans",
            font_size=36,
...
class Bio42Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-4-2")
    print(f"To render: manim -ql bio8-4-2.py Bio42Scene")
    print(f"For 3D: manim -ql bio8-4-2.py Bio42Scene3D")
