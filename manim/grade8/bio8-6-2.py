...
Lesson: bio8-6-2 — Подредување на рбетници
...
class Bio62Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Подредување на рбетници!",
            font="Noto Sans",
            font_size=36,
...
class Bio62Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-6-2")
    print(f"To render: manim -ql bio8-6-2.py Bio62Scene")
    print(f"For 3D: manim -ql bio8-6-2.py Bio62Scene3D")
