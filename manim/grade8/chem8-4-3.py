...
Lesson: chem8-4-3 — Реакции со кислород — оксиди
...
class Chem43Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Реакции со кислород — оксиди!",
            font="Noto Sans",
            font_size=36,
...
class Chem43Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: chem8-4-3")
    print(f"To render: manim -ql chem8-4-3.py Chem43Scene")
    print(f"For 3D: manim -ql chem8-4-3.py Chem43Scene3D")
