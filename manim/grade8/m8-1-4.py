...
Lesson: m8-1-4 — Математички операции
...
class Math14Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Математички операции!",
            font="Noto Sans",
            font_size=36,
...
class Math14Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: m8-1-4")
    print(f"To render: manim -ql m8-1-4.py Math14Scene")
    print(f"For 3D: manim -ql m8-1-4.py Math14Scene3D")
