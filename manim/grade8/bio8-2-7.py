...
Lesson: bio8-2-7 — Држечка положба, повреди и здравје на мускули
...
class Bio27Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Држечка положба, повреди и здравје на мускули",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Држечка положба, повреди и здравје на мускули!",
            font="Noto Sans",
            font_size=36,
...
class Bio27Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Држечка положба, повреди и здравје на мускули (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-2-7")
    print(f"To render: manim -ql bio8-2-7.py Bio27Scene")
    print(f"For 3D: manim -ql bio8-2-7.py Bio27Scene3D")
