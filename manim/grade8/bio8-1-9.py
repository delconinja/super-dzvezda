...
Lesson: bio8-1-9 — Рефлексен лак — брзи автоматски реакции
...
class Bio19Scene(Scene):
    ...
    def hook(self):
        ...
        title = Text(
            "Рефлексен лак — брзи автоматски реакции",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
            weight=BOLD
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Рефлексен лак — брзи автоматски реакции!",
            font="Noto Sans",
            font_size=36,
...
class Bio19Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Рефлексен лак — брзи автоматски реакции (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: bio8-1-9")
    print(f"To render: manim -ql bio8-1-9.py Bio19Scene")
    print(f"For 3D: manim -ql bio8-1-9.py Bio19Scene3D")
