...
Lesson: phys8-2-4 — Извори на електрична енергија
...
class Phys24Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Извори на електрична енергија!",
            font="Noto Sans",
            font_size=36,
...
class Phys24Scene3D(ThreeDScene):
    """
    ...
    def construct(self):
        ...
        title = Text(
            "Извори на електрична енергија (3D)",
            font="Noto Sans",
            font_size=44,
            color=COLOR_PRIMARY,
        )
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: phys8-2-4")
    print(f"To render: manim -ql phys8-2-4.py Phys24Scene")
    print(f"For 3D: manim -ql phys8-2-4.py Phys24Scene3D")
