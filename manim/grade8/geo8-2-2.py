...
Lesson: geo8-2-2 — Економија на Европа
...
class Geo22Scene(Scene):
    ...
    def closer(self):
        ...
        recap = Text(
            "Remember: You now understand Економија на Европа!",
            font="Noto Sans",
            font_size=36,
...
class Geo22Scene3D(ThreeDScene):
    """
...
if __name__ == "__main__":
    print(f"Auto-generated Manim scene: geo8-2-2")
    print(f"To render: manim -ql geo8-2-2.py Geo22Scene")
    print(f"For 3D: manim -ql geo8-2-2.py Geo22Scene3D")
